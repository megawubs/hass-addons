...
> stops strict clients — including the OPDS Proxy add-on — from recognising
> the feed as a catalog. The fork carries the fix, pending a pull request
> upstream. See the comment in the `Dockerfile` for how to revert.
